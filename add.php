...
$PAGE->set_url ( '/blocks/hsmail/add.php', array ( 'id' => $id ) ); // このファイルのURLを設定
...
$PAGE->navbar->add ( get_string ( 'condition1', 'block_hsmail' ), "?id=$id" );
...
if ( $mform->is_cancelled () ) {
    ...
    redirect ( new moodle_url ( '/blocks/hsmail/jobsetting.php', array ( 'id' => $id ) ) );
