...
$PAGE->set_title ( get_string( 'hsmail_settings', 'block_hsmail' ) ); // ブラウザのタイトルバーに表示されるタイトル
$PAGE->set_heading ( $course->shortname ); // ヘッダーに表示する文字列
$PAGE->set_pagelayout ( 'incourse' );
$PAGE->navbar->add ( get_string( 'hsmail_settings', 'block_hsmail' ), "?id=$id" ); // ヘッダーのナビゲーションに項目追加
...
echo $OUTPUT->heading ( get_string( 'hsmail_settings', 'block_hsmail' ) ); // メインエリアのタイトル
